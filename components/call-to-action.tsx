            ...
            <div className="md:w-1/2 p-8 md:p-12">
              ...
              >
                ...
                <p className="text-rose-100 mb-8 text-lg">
                  ...
                  community of heroes today and be part of someone&apos;s
                  miracle.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/schedule">
                    <Button
                      size="lg"
                      className="bg-white text-rose-600 hover:bg-gray-100 w-full"
                    >
                  ...
                  <Link href="/find-donor">
                    <Button
                      size="lg"
                      className="bg-rose-700 text-white hover:bg-rose-800 w-full"
                    >
                ...
                <div className="mt-8 flex items-center">
                  ...
                  <span className="text-white">
                    <span className="font-semibold">24/7 Hotline:</span> +1
                    (800) DONATE
                  </span>
                </div>
              </motion.div>
            ...
            <div className="md:w-1/2 relative" style={{ minHeight: "300px" }}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-black to-transparent">
                <blockquote className="text-white italic">
                  &quot;The blood you donate gives someone another chance at
                  life. One day that someone may be a close relative, a friend,
