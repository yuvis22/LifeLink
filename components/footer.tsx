    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Connecting donors to save lives. Every drop counts.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/resources/blood-type-guide"
                  className="text-gray-600 hover:text-rose-600"
                >
                  Blood Type Guide
                </Link>
              ...
              <li>
                <Link
                  href="/resources/donation-eligibility"
                  className="text-gray-600 hover:text-rose-600"
                >
              ...
              <li>
                <Link
                  href="/resources/donation-process"
                  className="text-gray-600 hover:text-rose-600"
                >
                  Donation Process
                </Link>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  123 Donation St, Health City, HC 12345
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 text-center text-gray-500 text-sm">
          <p>
            © {new Date().getFullYear()} LifeLink Blood Donor Network. All
            rights reserved.
          </p>
        </div>
      </div>
